...
import beneficios1 from '../../ilustraciones/beneficios1.png'
import beneficios2 from '../../ilustraciones/beneficios2.png'
...
export const Partners = () => {
  ...
  return (
    <> 
        ...
        <div className="beneficios flex flex-col items-center justify-evenly">
            <div className='beneficios_title'>
                <h2 className='text-center font-bold'>Beneficios</h2>
            </div>
            <div className='flex items-start justify-evenly w-full'>
                <div className="beneficios_card flex flex-col items-start justify-center">
                ...
                <div className="beneficios_card2 flex flex-col items-start justify-center">
        ...
        <div className="partners_logos">
            ...
            <div className="filtros_logos flex items-start justify-around">

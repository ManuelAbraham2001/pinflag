...
const Servicios = () => {
  return (
    <>
        <div className="step_nav flex items-center justify-between mx-auto">
            <button autoFocus>Puntos Pick-up</button>
            <button>Omnicanalidad</button>
            <button>Creador de etiquetas</button>
            <button>Trazabilidad y Packaging</button>
            <button>Check-out en línea</button>
        </div>

        <div className="servicios_container flex items-center justify-evenly">
            <div className="servicios_title flex flex-col items-center justify-center gap-12">
        ...
        <div className="puntos_pickup_container">
            <div className="puntos_pickup_header flex items-center justify-center">
        ...
        <div className="pickup_servicios_container">
            <div className="pickup_servicios flex items-center justify-evenly shadow-lg">
                <div className="pickup_servicios_content flex flex-col items-start justify-center gap-10">
                ...
                <div className="pickup_servicios_img">
            ...
            <div className="pickup_servicios flex items-center justify-evenly shadow-lg">
                ...
                <div className="pickup_servicios_img order-first">
